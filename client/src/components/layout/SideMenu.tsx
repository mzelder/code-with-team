...
function SideMenu() {
    ...
    return (
    <aside className="flex flex-col items-center justify-items-center w-20 h-screen py-8 pt-0 overflow-y-auto bg-white border-r rtl:border-l rtl:border-r-0 dark:bg-gray-900 dark:border-gray-700">
      <img className="w-auto h-25 object-cover" src="/cwt_logo.svg" alt="Cwt logo" />
